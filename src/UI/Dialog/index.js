...
function standardizeButton(button) {
    ...
    return Object.assign({ value: button.name }, button);
}
...
const getHtml = (options) => getHtmlOutput(options).getContent();
exports.getHtml = getHtml;
function bindTo(root) {
    var _a;
    return _a = class {
        },
        _a.showModal = (options) => (0, exports.showModal)(Object.assign(Object.assign({}, options), { root })),
        _a.showModeless = (options) => (0, exports.showModeless)(Object.assign(Object.assign({}, options), { root })),
        _a.getHtmlOutput = (options) => getHtmlOutput(options),
        _a.getHtml = (options) => (0, exports.getHtml)(options),
        _a;
}
